...
Try to verify if your solution works if number of elements is as large as 105
 ...
 Food for thought :
Even though it might not be required in this problem, in some cases, you might be required to order the operation
s cleverly so that the numbers do not overflow.
